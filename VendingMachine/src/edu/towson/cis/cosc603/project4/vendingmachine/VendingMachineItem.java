...
public class VendingMachineItem {
	...
	// Exception message for when the item doesnt have a name
	private final static String NAME_IS_EMPTY = "Name can not be empty.";
	/**
	...
	public VendingMachineItem( String name, double price ) throws VendingMachineException {
		if(name == null) {
			throw new VendingMachineException(NAME_IS_EMPTY);
		}
		this.name = name;
		if( price < 0 ) {
