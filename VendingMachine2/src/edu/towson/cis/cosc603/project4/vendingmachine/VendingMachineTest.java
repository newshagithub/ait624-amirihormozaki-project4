...
public class VendingMachineTest {
	...
	public void testAddItem_2()
		throws Exception {
		VendingMachine fixture = new VendingMachine();
		VendingMachineItem item = new VendingMachineItem("item", 1.0);
		fixture.addItem(item, "B");
		VendingMachineItem item2 = new VendingMachineItem("item2", 2.0);
		
		fixture.addItem(item2, "B");
	...
	public void testMakePurchase_3()
		throws Exception {
		VendingMachine fixture = new VendingMachine();
		fixture.insertMoney(2);
		VendingMachineItem item = new VendingMachineItem("item", 1.25);
		fixture.addItem(item, "B");
		fixture.makePurchase("B");

		// add additional test code here
		assertEquals(.75, fixture.balance, 1.0);
	}
